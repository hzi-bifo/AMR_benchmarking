...
conda env create -n ${amr_env_name2}  -f ./install/amr_env2.yml
conda env create -n ${resfinder_env}  -f ./install/res_env.yml || { echo "Errors in installing env."; exit; }

####3.PhenotypeSeeker.
conda env create -n ${PhenotypeSeeker_env_name}  -f ./install/PhenotypeSeeker_env.yml  || { echo "Errors in installing env."; exit; }
...
###conda env create -n ${perl_name}  -f ./install/perl5_22_env.yml || { echo "Errors."; exit; }
