...
wait
echo $CONDA_DEFAULT_ENV
conda install -y pip 19.3.1|| { echo "Errors."; exit; }
...
#conda init
#source activate ${phylo_r_name}|| { echo "Errors in activate env."; exit; }
#wait
#echo $CONDA_DEFAULT_ENV
#conda install -c conda-forge r=3.4.1|| { echo "Errors."; exit; }
#conda deactivate
