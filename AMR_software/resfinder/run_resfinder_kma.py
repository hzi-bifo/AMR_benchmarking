...
if args.acquired is True:
    ...
    if(args.inputfasta):
        out_res_kma = args.out_path + "/resfinder_kma_modified"#modified khu
    ...
    if(args.inputfasta):
        ...
        #                                            "ResFinder")
        kma_run = acquired_finder.kma(inputfile_1=args.inputfasta,
                                      inputfile_2=None,
...
if args.point is True and args.species:
    ...
    if(args.inputfasta):
        out_point = os.path.abspath(args.out_path + "/pointfinder_kma_new")
    ...
    if(args.inputfasta):
        ...
        kma_run = finder.kma(inputfile_1=args.inputfasta,
                             inputfile_2=None,
                             out_path=out_point,
