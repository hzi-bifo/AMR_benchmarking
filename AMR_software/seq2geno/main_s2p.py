    ...
    if f_prepare_meta:
        ...
        for species, antibiotics in zip(df_species, antibiotics):
            ...
            for anti in antibiotics:
                ...
                pseudo.fill (fileDir+'/AMR_software/'+software_name+'/examples/CH2500.1.fastq.gz,'+fileDir+'/AMR_software/'+software_name+'/examples/CH2500.2.fastq.gz')
            ...
            ###pseudo inputs: only provided for the sake of original pipeline checking procedure.
            ### Not used in our benchmarking pipeline.
            list_of_lines[16] = "    %s\n" % pseudo_args[0]
            list_of_lines[18] = "    %s\n" % pseudo_args[1]
            list_of_lines[20] = "    %s\n" % pseudo_args[2]
            list_of_lines[22] = "    %s\n" % pseudo_args[3]
    ...
    if f_ml:
        ...
        for species, antibiotics in zip(df_species, antibiotics):
            ...
            for anti in antibiotics:
                ...
                y_all = Y[i_anti]
                i_anti+=1
                mer6_file ,_, _, _, _,log_feature,_ =  name_utility.GETname_S2Gfeature(species, temp_path,6)
