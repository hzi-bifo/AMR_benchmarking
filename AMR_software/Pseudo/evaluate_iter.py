...
#### 1. Feature building for iterative evaluation for each of the classifier
EVAL.prepare_feature()

### 2.  Feature building for CV to select the optimal classifier at each iteration
EVAL.prepare_feature_val()
