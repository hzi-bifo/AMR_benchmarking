...
def run(species,path_sequence,path_large_temp,list_species,level,f_all,f_pre_meta,f_phylo_prokka,f_phylo_roary,
    ...
    if f_nn == True:
        ...
        nn_module_multiA.multiAnti(species,antibiotics, level, path_x, path_y, path_name, path_mutation_gene_results_multi, cv,[0,1], random,
        ...
        # score=nn_module_multiA.multiAnti_score(species,antibiotics, level, path_x, path_y, path_name, path_mutation_gene_results_multi, cv, random,
        #                      re_epochs, f_scaler, f_fixed_threshold, f_nn_base,f_phylotree,f_random, f_optimize_score, save_name_score,0.0,0, None,
