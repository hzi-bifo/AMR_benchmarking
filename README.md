...
- Memory requirment:  Aytan-Aktug multi-species model needs up to 370G memory. Some other procedures requiring large memory are KMA clustering in  Aytan-Aktug SSSA. TODO
...
|n_jobs| CPU cores to use. We advise users to use a PC equipped with at least 10 cores, as e.g. a procedure for evaluating Kover is set to use 10 cores.  | 10 |
