...
- Dependencies
    ...
    - Install [Blastn](https://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/LATEST/) for [ResFinder](https://bitbucket.org/genomicepidemiology/resfinder/src/master/), and make sure that "blastn" is in you PATH.
