...
1.1 Download all the genomes with AMR phenotype meta-data generated by laboratory methods. This results in 99 species, including 67836 strains/genomes.

1.2 Retain the species that contain larger than 500 strains. This results in 13 species.
...
1.3 Qaulity control over 13 selected species: 
...
1.4 Retain strains with phenotype either R(resistant) or S(susceptible), i.e. strains with only I(intermediate)or none phenotype are excluded.

1.5 Retain the species with at least 100 strains w.r.t.  each antibiotic’s each R and S phenotype classrespectively. 
