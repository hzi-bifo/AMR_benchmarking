...
|merge_name| used to notate the folders for the results of three Aytan-Aktug multi-species multi-antibiotic models. Always takes such a form of a concatenation of species names in the order defined by `species_list`. E.g. only two species of Mycobacterium_tuberculosis and Salmonella_enterica will result in Mt_Se.|Mt_Se_Sp_Ec_Sa_Kp_Ab_Pa_Cj|
