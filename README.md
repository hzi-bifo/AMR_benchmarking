...
|merge_name| used to notate the folders for saving the results of three Aytan-Aktug multi-species multi-antibiotic models. Always takes such form of a concatenation of species names in order. |Mt_Se_Sp_Ec_Sa_Kp_Ab_Pa_Cj|
