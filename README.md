...
- One could see `main.sh` for whole benchmarking workflow in this study, which goes through the whole benchmarking process including: conda environment installation, data downloading/reprocessing, evaluating Point-/Resfinder, evaluating Aytan-Aktug, evaluating Seq2Geno2Pheno, evaluating Phenotyperseeker, evaluating Kover, evaluating ML baseline (majority), and benchmarking results visualization. 
