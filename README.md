...
- Pyhton environment
    ...
    - Create 8 pieces of conda environments and install packages respectively. If coming across with creating environment for Kover, please refer to [Kover](https://aldro61.github.io/kover/doc_installation.html) to try other installation methods.
        ```
        bash ./install/install.sh
        ```
    - Install pytorch in the `multi_env` and `multi_torch_env` manually. To install pytorch compatible with your CPU or CUDA version, please fellow this instruction: https://pytorch.org/get-started/locally/. Our code was tested with pytorch v1.7.1, with CUDA Version 10.1 and 11.0 .
