...
def cmd(path,strain_ID,species):
    cmd_acquired = ("python3 run_resfinder.py"
                    ...
                    + " -o  /net/sgi/metagenomics/data/khu/benchmarking/resfinder_results/" + str(
    ...
    try:
        if species in ['Klebsiella pneumoniae','Escherichia coli','Staphylococcus aureus','Mycobacterium tuberculosis','Salmonella enterica',
            ...
            if check_miss==True:
                ...
                if not has_handle(("/net/sgi/metagenomics/data/khu/benchmarking/resfinder_results/" + str(species.replace(" ", "_"))+'/'+str(strain_ID))):
                    already =os.listdir("/net/sgi/metagenomics/data/khu/benchmarking/resfinder_results/" + str(species.replace(" ", "_"))+'/'+str(strain_ID))
...
def determination(species,n_jobs,check,check_miss):
    ...
    print(species)
    logDir = os.path.join("/net/sgi/metagenomics/data/khu/benchmarking/resfinder_results/"+str(species.replace(" ", "_"))+"/")
