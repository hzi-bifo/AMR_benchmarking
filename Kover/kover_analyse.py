...
def extract_info_species( level,species,score,antibiotics,cv,f_phylotree,f_kma):
...
if __name__ == '__main__':
    ...
    extract_info( parsedArgs.level,parsedArgs.species, parsedArgs.score,parsedArgs.cv,parsedArgs.f_phylotree,
