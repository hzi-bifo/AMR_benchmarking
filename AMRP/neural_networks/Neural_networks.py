...
def eval(species, antibiotics, level, xdata, ydata, p_names, p_clusters, cv, Random_State,
    ...
    #Only for analyze the results in AMRP result_anylysis.py version.

    score2= [f1_test,score_report_test,aucs_test,mcc_test, hyperparameters_test,hyperparameters_test,thresholds_selected_test]
