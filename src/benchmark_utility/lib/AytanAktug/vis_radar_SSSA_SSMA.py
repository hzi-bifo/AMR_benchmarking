...
def extract_info(fscore,output_path):
    ...
    labels = ['Single-species multi-antibiotics Mean','Single-species-antibiotic Mean','Single-species multi-antibiotics Standard deviation','Single-species-antibiotic Standard deviation' ]
